...
class MessageCategory extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(messageActions.getMessageCategoryList(temp))
  ...
  handlePageClick = (data) => {
    ...
    this.props.dispatch(messageActions.getMessageCategoryList(datatemp));
  }
  handleSearch = (event) => {
    ...
    this.props.dispatch(messageActions.getMessageCategoryList(data));
  }
  disableMessageCategory = (data) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => this.props.dispatch(messageActions.disableMessageCategory(datatemp, paginationdata))
        },
        {
          label: 'No'
        }
  ...
  deleteMessageCategory = (data) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => this.props.dispatch(messageActions.deleteMessageCategory(datatemp, paginationData))
        },
        {
          label: 'No'
        }
  ...
  createMessageSubmit = () => {
    ...
    if (this.handleValidationAddMessage()) {
      ...
      this.props.dispatch(messageActions.createMessageCategory(reqData));
    }
  ...
  updateMessageSubmit = () => {
    ...
    if (this.handleValidationUpdateMessage()) {
      ...
      this.props.dispatch(messageActions.updateMessageCategory(reqData, paginationData));
    }
  ...
  handleValidationUpdateMessage = () => {
    ...
    //flag
    // if (!fieldsMessageUpdate["flag"] || fieldsMessageUpdate["flag"] === "") {
    //   formIsValid = false;
    //   errorsMessageMassage["flag"] = "Cannot be empty";
    // }


    //name
    if (!fieldsMessageUpdate["name"] || fieldsMessageUpdate["name"] === "") {
      formIsValid = false;
      errorsMessageMassage["name"] = "Cannot be empty";
    }
  ...
  handleValidationAddMessage = () => {
    ...
    //MessageCategoryId
    // if (!fieldsMessage["flag"] || fieldsMessage["flag"] === "") {
    //   formIsValid = false;
    //   errorsMessage["flag"] = "Cannot be empty flag";
    // }
    //name
    if (!fieldsMessage["name"] || fieldsMessage["name"] === "") {
      formIsValid = false;
      errorsMessage["name"] = "Cannot be empty name";
    }
              ...
              <div className="mx-auto max-w-screen-3xl">
                ...
                <section className="p-6 space-y-6 bg-white border rounded-md">
                  ...
                  <div className="flex flex-wrap items-center justify-between w-full ">
                    <div className="">
                      <h3 className="text-xl font-semibold ">Message Category</h3>
                    </div>
                    ...
                    <div className='flex space-x-6 '>
                      ...
                      <button className="flex items-center px-2 py-2 text-sm font-medium text-white capitalize bg-[#2a3042]/80  rounded-md " onClick={() => this.handleOpenCreateModal()}><MdAdd style={{ fontSize: "1.5rem" }} className="mr-1.5" />  Add Message Category </button>
                      ...
                      <div className="inline-block min-w-full">
                        <div className="">
                          <table className="min-w-full border-0 divide-y">
                            ...
                            <tbody>
                              {
                                getMessageCategoryList && getMessageCategoryList.length > 0 ?
                                  getMessageCategoryList.map((element, index) => (<React.Fragment key={element.id}>
...
export default connect(mapStateToProps)(MessageCategory);
