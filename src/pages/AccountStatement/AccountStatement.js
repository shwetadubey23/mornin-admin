      ...
      <div className='relative w-full h-full page_bg overflow-y-auto'>
        <div className='px-[12px] py-[4px] space-y-6' >
          ...
          <div className='flex justify-between' >
            <h2 className='xl:text-[16px] text-[14px]  font-semibold text-gray-600 uppercase'>Account Satement</h2>
            <p className='text-[0.8125rem]  text-[#74788d] '>  <b className='font-normal text-[#495057]' >Home</b> / Account Satement </p>
          </div>

          <div>
            <div className=' bg-white xl:p-[1.25rem] p-[0.5rem] rounded-[.25rem]'>

              <div className='w-full bg-white flex flex-col  space-y-4 pb-4'>

                <div className='md:flex items-end  md:space-x-4 md:space-y-0 space-y-2'>
                  <div className='space-y-1 '>
                    <label className='text-[.8125rem] font-[500]  text-[#495057] '>Search by Client Name</label><br />
                    <input className="px-[12px] py-[7.520px] text-[0.8125rem] bg-white bg-transparent  border border-[#ced4da] rounded-[0.25rem]  md:w-60 w-full focus:outline-none text-[#495057] placeholder:text-gray-500 " placeholder='Search option' id="exampleSearch2" type="text" required />
                  ...
                  <div className='space-y-1'>
                    <label className='text-[.8125rem] font-[500]  text-[#495057] '>Type</label>
                      ...
                      <table className="min-w-full capitalize border border-collapse ">
                        <thead className="">
                          <tr className="text-left text-[12px]  text-gray-600 bg-white border-b border-t">
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize border-r ">
                            ...
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize border-r text-right">
                            ...
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize border-r text-right">Debit</th>
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize border-r text-right  ">
                              <div className='flex justify-end items-center'>
                                <p> pts</p>
                                <img src='/images/download.svg' alt="sort" className='w-[0.65rem] h-[1rem] p-[1px] ml-[5px]' />
                            ...
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize border-r text-left ">
                              <div className='flex justify-between items-center'>
                                <p> Remark</p>
                                <img src='/images/download.svg' alt="sort" className='w-[0.65rem] h-[1rem] p-[1px] ml-[5px]' />
                              </div>
                        ...
                        <tbody className='divide-y'>
                          ...
                          <React.Fragment >
                            <tr className="text-[#495057] text-[12px] bg-white">
                              <td className="py-[4px] px-[6px] whitespace-nowrap border-r"> Demokoimoi</td>
                              <td className="py-[4px] px-[6px] cursor-pointer whitespace-nowrap border-r  text-right" > 1</td>
                              <td className="py-[4px] px-[6px] whitespace-nowrap border-r text-right text-green-600"> 8,52,300</td>
                              <td className="py-[4px] px-[6px] whitespace-nowrap border-r text-right">0</td>
                              <td className="py-[4px] px-[6px] whitespace-nowrap border-r text-right text-green-600"> 8,52,300</td>
                              <td className="py-[4px] px-[6px] whitespace-nowrap border-r text-left">opeing pts</td>
                              <td className="py-[4px] px-[6px] whitespace-nowrap border-r text-left">None</td>
                            </tr>
                            <tr className="text-[#495057] text-[12px] bg-white hover:bg-gray-100 transition duration-150 cursor-pointer">
                              <td colSpan={7} className="py-[4px] px-[6px] whitespace-nowrap text-center"> There are no records to show</td>
                            </tr>
                          </React.Fragment>
