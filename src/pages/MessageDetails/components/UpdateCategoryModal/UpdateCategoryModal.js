...
export default function UpdateCategoryModal(props) {
  ...
  let { UpdateMessageCreateModal, handleAppSeetingHideModal, errorsUpdateMessage, inputChangeUpdateMessage, updateMessageSubmit, allMessage, fieldsMessageUpdate
  } = props;


// const fieldsMessageUpdate=(ele)=>{
// console.log();
          ...
          <form autoComplete="off" className="p-4 space-y-4 capitalize border border-gray-300 ">
            ...
            <div className="w-full">
              ...
              <select class="form-select border-1 px-3 py-2 placeholder-blueGray-400 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" aria-label="Default select example" onChange={inputChangeUpdateMessage} id="messageSubCategoryId" name="messageSubCategoryId"
                   value={fieldsMessageUpdate && fieldsMessageUpdate["messageSubCategoryId"] && fieldsMessageUpdate["messageSubCategoryId"].id ? fieldsMessageUpdate["messageSubCategoryId"].id  : null} >
