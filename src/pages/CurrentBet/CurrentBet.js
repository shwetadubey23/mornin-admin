...
class CurrentBet extends React.Component {
  ...
  componentDidMount() {
    let data = { "betType": this.state.betType, "noOfRecords": this.state.noOfRecords, "sportType": 1, "index": this.state.index }
    this.props.dispatch(betActions.currentBets(data));
  }
  ...
  handlePageClick = (data) => {
    ...
    let pagination = { "betType": this.state.betType, "noOfRecords": this.state.noOfRecords, "sportType": 1, "index": data.selected }
  ...
  handleShowEnties = (data) => {
    ...
    let pagination = { "betType": this.state.betType, "noOfRecords": data, "sportType": 1, "index": 0 }
    this.props.dispatch(betActions.currentBets(pagination));
  ...
  handleBetType = (data) => {
    ...
    let pagination = { "betType": data, "noOfRecords": this.state.noOfRecords, "sportType": 1, "index": this.state.index }
    this.props.dispatch(betActions.currentBets(pagination));
  ...
  render() {
    ...
    console.log("RENDER______currentBetsItems::I", currentBetsItems);
        ...
        <div className='relative w-full h-full page_bg overflow-y-auto'>
          <div className='px-[12px] py-[4px] space-y-0' >
            ...
            <div className='flex justify-between pb-4' >
              <h2 className='xl:text-[16px] text-[14px]  font-semibold text-gray-600 uppercase'>Current Bet</h2>
              <p className='text-[0.8125rem]  text-[#74788d] '>  <b className='font-normal text-[#495057]' >Home</b> / Current Bet </p>
            </div>
