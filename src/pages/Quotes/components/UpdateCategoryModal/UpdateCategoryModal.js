...
export default function UpdateCategoryModal(props) {
  ...
  return (
    ...
    <div className={UpdateQuotesCreateModal ? "fixed w-full top-0 left-0 h-full inset-0 z-40 overflow-hidden mt-0 flex justify-center items-center overflow-y-auto bg-black/40 md:p-0 p-1" : "hidden"} style={{ marginTop: '0rem', }}  >
        ...
        <div className="p-4">
          ...
          <form autoComplete="off" className="p-4 space-y-4 capitalize border border-gray-300 ">
            ...
            <div className="w-full">
              ...
              {errorsUpdateQuotes && errorsUpdateQuotes["quotesSubCategoryId"] ?
            ...
            <div className="w-full">
              ...
              <input className={` w-full p-2 mt-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-2 ring-gray-500  ${errorsUpdateQuotes && !errorsUpdateQuotes["quotes"] ? "border  placeholder-gray-500" : "border  border-red-500 "}`}
            ...
            {/* {
              ...
              filesDetails && filesDetails.imageURL ?
                ...
                <div>
                  <div className='flex justify-between px-4'>
                    <img className="object-cover w-24 h-20 rounded-sm" src={fieldsQuotesUpdate && fieldsQuotesUpdate.imageLinkUrl ? fieldsQuotesUpdate.imageLinkUrl : null} alt="not found" />
                  </div>
