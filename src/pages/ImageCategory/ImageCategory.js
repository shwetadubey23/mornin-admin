                ...
                <section className="p-6 space-y-6 bg-white border rounded-md">
                  ...
                  <div className="flex flex-wrap items-center justify-between w-full ">
                    ...
                    <div className='flex space-x-6 '>
                      ...
                      <button className="flex items-center px-2 py-2 text-xs w-52 lg:text-sm font-medium text-white capitalize bg-[#2a3042]/80  rounded-md " onClick={() => this.handleOpenCreateModal()}><MdAdd style={{ fontSize: "1.5rem" }} className="mr-1.5" />  Add Image Category  </button>
