...
class AdminList extends React.Component {
  ...
  render() {
    ...
    let { creditdataItems, accountHistoryItems, childProfileItems, childListActiveItems, depositwithdrawItems, loading } = creditWithdraw;
        ...
        <div className='relative w-full h-full page_bg overflow-y-auto'>
          <div className='px-[12px] py-[4px] space-y-6' >
            <div className='flex justify-between' >
              <h2 className='xl:text-[16px] text-[14px]  font-semibold text-gray-600 uppercase'>Account list for active users</h2>
              <p className='text-[0.8125rem]  text-[#74788d] '>  <b className='font-normal text-[#495057]' >Home</b> / Active Users </p>
            </div>
                      ...
                      <table className="min-w-full  ">
                        <thead className="">
                          <tr className="text-left text-[12px]  text-gray-600 bg-white border-b border-t">
                            {/* <th scope="col" className="whitespace-nowrap py-[4px] px-[6px] py-2 font-semibold uppercase">ID</th> */}
                            ...
                            {/* <th scope="col" className="whitespace-nowrap p-4 py-2 font-[600] capitalize">userId</th> */}
                            ...
                            {/* <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-center">vcLock</th>
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-center">lcLock</th> */}
                            {/* <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize">id</th> */}
                            ...
                            {/* <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-center">betLock</th> */}
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-right">exposure</th>
                            <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-right">availabePts</th>
                            {/* <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-center">active</th> */}
                            ...
                            {/* <th scope="col" className="whitespace-nowrap px-[6px] py-[4px] font-[600] capitalize text-center">accountLock</th> */}
                              ...
                              childListActiveItems.dataList.map((element, index) => (
                                <React.Fragment >
                                  <tr className="text-[#495057] text-[12px] bg-white">
                                    ...
                                    {/* <td className="py-[4px] px-[6px] whitespace-nowrap">{element && element.userId ? element.userId : "-"}</td> */}
                                    ...
                                    {/* <td className="py-[4px] px-[6px] whitespace-nowrap text-center">{element && element.vcLock ? "Yes" : "No"}</td>
                                    <td className="py-[4px] px-[6px] whitespace-nowrap text-center">{element && element.lcLock ? "Yes" : "No"}</td> */}
                                    {/* <td className="py-[4px] px-[6px] whitespace-nowrap">{element && element.id ? element.id : "-"}</td> */}

                                    <td className="py-[4px] px-[6px] whitespace-nowrap text-right">{element && element.clientPl ? element.clientPl : "-"}</td>
                                    <td className="py-[4px] px-[6px] whitespace-nowrap text-right">{element && element.clientPlPercentage ? element.clientPlPercentage : "-"}</td>
                                    <td className="py-[4px] px-[6px] whitespace-nowrap text-right">{element && element.exposure ? element.exposure : "-"}</td>

                                    {/* <td className="py-[4px] px-[6px] whitespace-nowrap text-center">{element && element.betLock ? "Yes" : "No"}</td> */}
                                    <td className="py-[4px] px-[6px] whitespace-nowrap text-right">{element && element.availabePts ? element.availabePts : "-"}</td>
                                    {/* <td className="py-[4px] px-[6px] whitespace-nowrap text-center">{element && element.active ? "Yes" : "No"}</td> */}
                                    ...
                                    {/* <td className="py-[4px] px-[6px] whitespace-nowrap text-center">{element && element.accountLock ? "Yes" : "No"}</td> */}
